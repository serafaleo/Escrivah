...
import 'package:escrivah/features/livros/presentation/pages/livros_page.dart';
      ...
      routes: <RouteBase>[
        ShellRoute(
          ...
          routes: <RouteBase>[
            GoRoute(
              path: Routes.livros,
              builder: (BuildContext context, GoRouterState state) => const LivrosPage(),
            ),
            GoRoute(
              path: Routes.busca,
